...
export const matches = [
  ...
  },
  {
    ...
    stats: {
      ...
      finalRound: 27,
      winnerHp: 6,
      notes: "Томоэ в теории контрила абилку Робина: после атаки он может отбежать, а Томоэ бьёт тех, кто выбегает из её зоны. Но у разбойников нашлись карты на 2 урона, игнорирующие значение и текст карты противника — против них не работает ничего, кроме уловки, а уловки у Томоэ нет. В итоге она впитала 8 урона за игру без единого шанса на сопротивление и погибла, оставив Робина Гуда с 6 HP, одним разбойником и одной картой в колоде.",
      rating: null,
    },
    nextMatchId: "r16-5",
    nextMatchSlot: "A",
  },
  {
    ...
    stats: {
      ...
      finalRound: 33,
      winnerHp: 5,
      notes: "Над этим матчем смеялись с самой жеребьёвки — главный аутсайдер турнира против одного из фаворитов, казалось бы, лёгкая победа для Сунь Укуна. Но игра растянулась на 33 хода, и Король Артур продержался огромное количество времени, погибнув в итоге от нехватки карт, а не от урона. Мерлин был на позиции MVP — заблокал атаку на 7 урона и не раз огрызался в ответ, да и сам Артур однажды выдал атаку на 9. Не заканчивайся у Артура карты — добил бы обезьяну. Но вышел из игры красиво.",
      rating: null,
    },
    nextMatchId: "r16-5",
    nextMatchSlot: "B",
